...
IF NOT EXISTS (
    ...
    WHERE [MigrationId] = N'20250911094425_init'
)
BEGIN
...
BEGIN
    CREATE TABLE [AspNetUsers] (
        ...
        [PasswordResetOtpExpiry] datetime2 NULL,
        [ProfilePictureUrl] nvarchar(max) NULL,
        [ProfilePicturePublicId] nvarchar(max) NULL,
...
BEGIN
    ...
    VALUES (N'20250911094425_init', N'9.0.8');
END;
